...
--New Bounty Hunter Abilities
RunSlashCommandsFile("criticalShot.lua")
RunSlashCommandsFile("criticalShot_1.lua")
RunSlashCommandsFile("criticalShot_2.lua")
RunSlashCommandsFile("confusionShot_1.lua")
RunSlashCommandsFile("eyeShot_1.lua")
RunSlashCommandsFile("sprayShot_1.lua")
RunSlashCommandsFile("underHandShot_1.lua")