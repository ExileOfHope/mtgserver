...
FsSad2Theater8 = GoToTheater:new {
	-- Task properties
...
function FsSad2Theater8:onTheaterCreated(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function FsSad2Theater8:notifyKilledMobile(pVictim, pAttacker)
