...
FsSad2Theater1 = GoToTheater:new {
	-- Task properties
	taskName = "FsSad2Theater1",
	...
	theater = {
		...
		{ template = "object/static/structure/general/camp_campfire_logs_smoldering_s01.iff", xDiff = 0.089, zDiff = 0.0077, yDiff = 0.682, heading = -16.464 },
		{ template = "object/static/structure/general/prp_junk_s8.iff", xDiff = 0.513, zDiff = 0.247, yDiff = -2.335, heading = 0 },
		{ template = "object/static/structure/general/camp_stool_short_s01.iff", xDiff = 0.4, zDiff = -0.0404, yDiff = 1.733, heading = 0 },
		{ template = "object/static/structure/general/camp_stool_short_s01.iff", xDiff = -1.521, zDiff = -0.21, yDiff = 0.653, heading = 0 },
...
function FsSad2Theater1:onObjectsSpawned(pPlayer, spawnedMobileList)
	if (pPlayer == nil) then
		return
	end
...
function FsSad2Theater1:onTheaterCreated(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function FsSad2Theater1:notifyKilledMobile(pVictim, pAttacker)
	...
	if (numEnemies <= 0) then
		QuestManager.completeQuest(pOwner, QuestManager.quests.FS_QUESTS_SAD2_TASK1)
		QuestManager.activateQuest(pOwner, QuestManager.quests.FS_QUESTS_SAD2_RETURN1)
