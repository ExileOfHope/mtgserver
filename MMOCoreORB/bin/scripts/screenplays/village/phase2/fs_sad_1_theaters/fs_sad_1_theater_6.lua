...
FsSad1Theater6 = GoToTheater:new {
	-- Task properties
	taskName = "FsSad1Theater6",
...
function FsSad1Theater6:onTheaterCreated(pPlayer)
	if (pPlayer == nil) then
		return
	end
...
function FsSad1Theater6:notifyKilledMobile(pVictim, pAttacker)
