...
object_draft_schematic_bio_engineer_bio_component_bio_component_food_light_flavor = object_draft_schematic_bio_engineer_bio_component_shared_bio_component_food_light_flavor:new {
   ...
   targetTemplate = "object/tangible/component/bio/bio_component_food_light_flavor.iff",
