...
object_draft_schematic_bio_engineer_bio_component_bio_component_food_medium_nutrition = object_draft_schematic_bio_engineer_bio_component_shared_bio_component_food_medium_nutrition:new {

   templateType = DRAFTSCHEMATIC,

   customObjectName = "Broad-Spectrum Nutrients",
   ...
   resourceQuantities = {35, 25, 20, 1},
   contribution = {100, 100, 100, 100},


   targetTemplate = "object/tangible/component/bio/bio_component_food_medium_nutrition.iff",
