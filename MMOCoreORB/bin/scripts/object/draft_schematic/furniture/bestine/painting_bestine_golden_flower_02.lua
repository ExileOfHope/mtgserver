...
object_draft_schematic_furniture_bestine_painting_bestine_golden_flower_02 = object_draft_schematic_furniture_bestine_shared_painting_bestine_golden_flower_02:new {
	templateType = DRAFTSCHEMATIC,

	customObjectName = "Abstract Painting of Golden Petals 2",
