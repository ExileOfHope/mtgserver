...
object_weapon_melee_baton_mandoviol_smasher = object_weapon_melee_baton_shared_mandoviol_smasher:new {
...
ObjectTemplates:addTemplate(object_weapon_melee_baton_mandoviol_smasher, "object/weapon/melee/baton/mandoviol_smasher.iff")
