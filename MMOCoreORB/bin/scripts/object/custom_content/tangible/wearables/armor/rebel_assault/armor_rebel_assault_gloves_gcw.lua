...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_assault_armor_rebel_assault_gloves_gcw, "object/tangible/wearables/armor/rebel_assault/armor_rebel_assault_gloves_gcw.iff")
