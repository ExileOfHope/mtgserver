...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_chitin_armor_chitin_acklay_chest_plate, "object/tangible/wearables/armor/chitin/armor_chitin_acklay_chest_plate.iff")
