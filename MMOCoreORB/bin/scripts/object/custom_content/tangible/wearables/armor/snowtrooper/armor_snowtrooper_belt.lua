...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_snowtrooper_armor_snowtrooper_belt, "object/tangible/wearables/armor/snowtrooper/armor_snowtrooper_belt.iff")
