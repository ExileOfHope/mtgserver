...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_spec_force_armor_rebel_spec_force_gloves_gcw, "object/tangible/wearables/armor/rebel_spec_force/armor_rebel_spec_force_gloves_gcw.iff")
