...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_rebel_battle_armor_rebel_battle_gloves_gcw, "object/tangible/wearables/armor/rebel_battle/armor_rebel_battle_gloves_gcw.iff")
