...
object_tangible_component_armor_armor_segment_kashyyykian_hunting_advanced = object_tangible_component_armor_shared_armor_segment_kashyyykian_hunting_advanced:new {
	...
	experimentalMax = {0, 0, 1000, 25, 1000, 0, 0, 0, 3, 1, 35, 1000},
	experimentalPrecision = {0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_kashyyykian_hunting_advanced, "object/tangible/component/armor/armor_segment_kashyyykian_hunting_advanced.iff")
