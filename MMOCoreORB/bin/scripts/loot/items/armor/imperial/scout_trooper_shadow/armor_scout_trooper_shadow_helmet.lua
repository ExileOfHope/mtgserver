...
armor_scout_trooper_shadow_helmet = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Imperial Commando Helmet",
...
addLootItemTemplate("armor_scout_trooper_shadow_helmet", armor_scout_trooper_shadow_helmet)
