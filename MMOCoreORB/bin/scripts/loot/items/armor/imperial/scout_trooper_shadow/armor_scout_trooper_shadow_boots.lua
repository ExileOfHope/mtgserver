...
armor_scout_trooper_shadow_boots = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Imperial commando Boots",
...
addLootItemTemplate("armor_scout_trooper_shadow_boots", armor_scout_trooper_shadow_boots)
