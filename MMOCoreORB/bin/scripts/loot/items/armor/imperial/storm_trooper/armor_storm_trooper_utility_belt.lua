...
armor_storm_trooper_utility_belt = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Stormtrooper Belt",
...
addLootItemTemplate("armor_storm_trooper_utility_belt", armor_storm_trooper_utility_belt)
