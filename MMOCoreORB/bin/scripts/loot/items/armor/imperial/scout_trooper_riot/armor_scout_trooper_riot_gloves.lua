...
armor_scout_trooper_riot_gloves = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Riot Trooper Gloves",
...
addLootItemTemplate("armor_scout_trooper_riot_gloves", armor_scout_trooper_riot_gloves)
