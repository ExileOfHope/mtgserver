...
armor_scout_trooper_riot_utility_belt = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Riot Trooper Belt",
...
addLootItemTemplate("armor_scout_trooper_riot_utility_belt", armor_scout_trooper_riot_utility_belt)
