...
armor_scout_trooper_riot_bicep_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Riot Trooper L Bicep",
...
addLootItemTemplate("armor_scout_trooper_riot_bicep_l", armor_scout_trooper_riot_bicep_l)
