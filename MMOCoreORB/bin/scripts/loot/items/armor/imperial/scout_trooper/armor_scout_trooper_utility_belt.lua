...
armor_scout_trooper_utility_belt = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Scout Trooper Belt",
...
addLootItemTemplate("armor_scout_trooper_utility_belt", armor_scout_trooper_utility_belt)
