...
armor_storm_trooper_purge_bracer_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Incinerator Trooper L Bracer",
...
addLootItemTemplate("armor_storm_trooper_purge_bracer_l", armor_storm_trooper_purge_bracer_l)
