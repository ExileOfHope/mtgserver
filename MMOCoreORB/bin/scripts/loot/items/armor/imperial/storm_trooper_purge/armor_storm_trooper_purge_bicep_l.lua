...
armor_storm_trooper_purge_bicep_l = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Incinerator Trooper L Bicep",
...
addLootItemTemplate("armor_storm_trooper_purge_bicep_l", armor_storm_trooper_purge_bicep_l)
