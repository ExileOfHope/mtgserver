...
armor_storm_trooper_purge_bracer_r = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "Incinerator Trooper R Bracer",
...
addLootItemTemplate("armor_storm_trooper_purge_bracer_r", armor_storm_trooper_purge_bracer_r)
